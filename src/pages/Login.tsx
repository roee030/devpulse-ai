        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-2xl">
          ...
          >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-accent/10 hover:bg-accent/20 border border-accent/30 hover:border-accent/60 text-accent font-semibold py-3 px-5 rounded-xl transition-all duration-150 active:scale-[0.98]"
            >
          ...
          <motion.p
            ...
            className="text-text-secondary text-xs text-center mt-5 leading-relaxed"
          >
            Demo uses synthetic data · No account needed
          </motion.p>
        </div>
